  ...
  return (
    <>
      ...
      <section className="section bg-gray-950">
        <div className="container-max grid md:grid-cols-2 gap-12">
          <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
            ...
            <h3 className="text-2xl font-bold text-white mb-3">Misi Kami</h3>
          ...
          <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
            <div className="text-3xl mb-4">🔭</div>
            <h3 className="text-2xl font-bold text-white mb-3">Visi Kami</h3>
            <p className="text-gray-400 leading-relaxed">
      ...
      <section className="section bg-gray-900">
        <div className="container-max">
          <div className="text-center mb-14">
            <span className="text-brand-400 font-semibold text-sm uppercase tracking-wide">Perjalanan Kami</span>
            <h2 className="text-4xl font-bold text-white mt-2">Sejarah Perusahaan</h2>
          </div>
          <div className="relative">
            <div className="absolute left-1/2 -translate-x-px top-0 bottom-0 w-0.5 bg-gray-700 hidden md:block" />
                ...
                <div key={m.year} className={`md:flex items-center gap-8 ${i % 2 === 0 ? '' : 'md:flex-row-reverse'}`}>
                  <div className={`md:w-1/2 ${i % 2 === 0 ? 'md:text-right' : ''}`}>
                    <div className="card p-6 inline-block w-full">
                      <span className="text-brand-400 font-bold text-lg">{m.year}</span>
      ...
      <section className="section bg-gray-950">
        <div className="container-max">
          <div className="text-center mb-14">
            <span className="text-brand-400 font-semibold text-sm uppercase tracking-wide">Budaya Kerja</span>
            <h2 className="text-4xl font-bold text-white mt-2">Nilai-Nilai Kami</h2>
          </div>
